...
ActiveRecord::Schema.define(version: 2020_03_23_184627) do
  ...
  create_table "tasks_users", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "user_id", null: false
